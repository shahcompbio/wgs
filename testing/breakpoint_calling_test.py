...
def main(dir1, dir2, files1, files2):
    ...
    pos_set2 = {tuple(x) for x in breakpoints2[["chromosome_1", "chromosome_2", "position_1", "position_2"]].values}
...
if __name__ == "__main__":
    main(dir1="/juno/work/shah/dgrewal/work/COMP_SCP/bkp/temp/sample_id/SA123/destruct",
         ...
         files2={"breakpoints": "TASK_1_RUN_breakpoint_table.txt",
                 "library": "TASK_1_RUN_breakpoint_library_table.txt"})
